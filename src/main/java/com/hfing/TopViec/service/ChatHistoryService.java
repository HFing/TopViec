...
public class ChatHistoryService {
    ...
    public List<ChatHistory> getChatHistory(String sender, String recipient) {
        return chatHistoryRepository.findBySenderAndRecipient(sender, recipient);
    }

    // Lấy danh sách người dùng đã nhắn tin
    public List<String> getDistinctUsers(String currentUser) { // Thêm tham số vào phương thức
