            ...
            <body>
                ...
                <div class="section companies">
                    <div data-w-id="fb490bb8-62db-fc28-81ac-81291b8b7495"
                        ...
                        <p class="paragraph companies">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mauris
                            risus
                        ...
                        <div class="w-dyn-list">
                            <div data-w-id="7a5d7a54-2f32-9280-d12f-413a1febc5c8"
                                ...
                                <c:forEach var="company" items="${companies}">
                                    ...
                                    <div role="listitem" class="company-item w-dyn-item"><a
                                            href="/companies/${company.id}" class="card company-item w-inline-block">
