<%@page contentType="text/html" pageEncoding="UTF-8" %>
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        <div data-w-id="56137bc8-507d-e022-9903-33a938c5d594"
            style="transform: translate3d(0px, 0px, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg, 0deg); opacity: 1; transform-style: preserve-3d;"
            class="content-top more-jobs">
            <div class="split-content content-top-more-jobs-left">
                <h2 class="title more-jobs">More job openings</h2>
            </div>
            <div class="split-content content-top-more-jobs-right"><a href="/" class="button-secondary w-button">All
                    jobs</a></div>
        </div>
        <div class="w-dyn-list">
            <div data-w-id="d9d4094b-ccc8-136e-0804-0353e66dd204"
                style="transform: translate3d(0px, 0px, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg, 0deg); opacity: 1; transform-style: preserve-3d;"
                role="list" class="jobs-grid w-dyn-items">
                <c:forEach var="job" items="${relatedJobs}">
                    <div role="listitem" class="job-item w-dyn-item"><a href="/job/${job.id}"
                            ...
                            <div class="split-content card-job-left">
                                ...
                                <div class="card-job-title-wrapper">
                                    <h3 class="title h6-size card-job" style="color: rgb(23, 23, 40);">${job.jobName}
                                    </h3>
                            ...
                            <div class="split-content card-job-right">
                                ...
                                <div class="card-job-category-wrapper">
                                    ...
                                    <div class="card-job-category-text">${job.career.name}g</div>
                                </div>
                            </div>
                        </a></div>
                </c:forEach>
                ...
                <!-- <div role="listitem" class="job-item w-dyn-item"><a href="/job/mobile-product-manager"
                        ...
                        <div class="split-content card-job-left">
                            ...
                            <div class="card-job-title-wrapper">
                                <h3 class="title h6-size card-job" style="color: rgb(23, 23, 40);">Mobile
                                    Product Manager</h3>
                                <div class="card-link-wrapper">
                ...
                <div role="listitem" class="job-item w-dyn-item"><a href="/job/head-of-product-design"
                        ...
                        <div class="split-content card-job-left">
                            ...
                            <div class="card-job-title-wrapper">
                                <h3 class="title h6-size card-job" style="color: rgb(23, 23, 40);">Head of
                                    Product Design</h3>
                                <div class="card-link-wrapper">
                ...
                <div role="listitem" class="job-item w-dyn-item"><a href="/job/customer-support-agent"
                        ...
                        <div class="split-content card-job-left">
                            ...
                            <div class="card-job-title-wrapper">
                                <h3 class="title h6-size card-job" style="color: rgb(23, 23, 40);">Customer
                                    Support Agent</h3>
                                <div class="card-link-wrapper">
                                    <div class="card-link">Youtube</div>
                                    <div class="card-link-arrow"
