...
<body>
    ...
    <div class="section job-post">
        <div class="container-default w-container">
            <div class="backlink-wrapper"><a href="/home" class="backlink"><span class="backlink-arrow"
                        style="transform: translate3d(0px, 0px, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg, 0deg); transform-style: preserve-3d;"></span>&nbsp;&nbsp;&nbsp;See
                    all jobs</a></div>
            <div class="job-post-wrapper">
                <div data-w-id="5086ac48-b95c-42a9-0a58-6e690b1c648f"
                    ...
                    <div class="card job-post">
                        <div data-w-id="ebcc2b89-9ed8-8b91-2d0e-6dfaa089b244" class="image-wrapper card-job-post"><img
                                src="https://assets-global.website-files.com/60c77302fcfa2bdb6e595f76/65276f1a19666fe5792f1797_webflow-banner.png"
                                alt="Webflow"
                                sizes="(max-width: 767px) 93vw, (max-width: 991px) 95vw, (max-width: 1439px) 74vw, 847px"
                                srcset="https://assets-global.website-files.com/60c77302fcfa2bdb6e595f76/65276f1a19666fe5792f1797_webflow-banner-p-500.png 500w, https://assets-global.website-files.com/60c77302fcfa2bdb6e595f76/65276f1a19666fe5792f1797_webflow-banner-p-800.png 800w, https://assets-global.website-files.com/60c77302fcfa2bdb6e595f76/65276f1a19666fe5792f1797_webflow-banner-p-1080.png 1080w, https://assets-global.website-files.com/60c77302fcfa2bdb6e595f76/65276f1a19666fe5792f1797_webflow-banner.png 1968w"
                        ...
                        <div class="card-job-post-content">
                            <div class="card-job-post-content-top">
                                <div class="card-job-post-title-wrapper">
                                    ...
                                    <h1 class="title h2-size card-job-post">Backend Software Engineer</h1>
                                </div>
                            ...
                            <div class="card-job-post-content-bottom">
                                <div class="job-description-title-wrapper">
                                    ...
                                    <div class="job-description-date-wrapper">
                                        <div class="job-description-date-text">Posted on:&nbsp;</div>
                                        <div>June 25, 2021</div>
                                    </div>
                                </div>
                                <div class="w-richtext">
                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Tellus augue sagittis
                                        erat consectetur est. Blandit blandit nec <a href="#">mauris pulvinar</a>.
                                        Lectus duis amet tortor, sit tincidunt. Rhoncus tincidunt imperdiet penatibus
                                        vitae risus, vitae. <strong>Blandit auctor</strong> justo nisl massa.</p>
                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Lectus dictum ultrices
                                        lacus sodales nunc felis eu, consectetur arcu. Vitae nulla scelerisque id
                                        pellentesque feugiat vel eu.</p>
                                </div>
                                <h2 class="title h3-size job-rich-text">Responsibilities</h2>
                                <div class="w-richtext">
                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Lectus dictum ultrices
                                        lacus sodales nunc felis eu, consectetur arcu. Vitae nulla scelerisque id
                                        pellentesque feugiat vel eu.</p>
                    ...
                    <div data-w-id="bd5ebe39-4c1d-b6ea-1c19-d384bef2b3eb"
                        ...
                        <div class="card job-post-sidebar">
                            ...
                            <div class="card-job-post-sidebar-content">
                                ...
                                <p class="paragraph card-job-post-sidebar">Please let Webflow know that you found this
